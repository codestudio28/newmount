...
@section('content')
  <div class="container-fluid">
          ...
          <h5 class="h5 mb-2 text-gray-800"><a href="/admin-paymentscheme">Payment Scheme</a> / Update Payment Scheme</h5>
       
        
        </div>
          <!-- DataTales Example -->
           {{ Form::open(['action' => ['PaymentSchemeController@update',$paymentscheme->id],'method'=>'POST'])}}
          <div class="row">
        ...
        {{Form::text('paymentname',$paymentscheme->paymentname,['class'=>'form-control','placeholder'=>'Enter payment name','required'=>true])}}
                  </div>
               </div>
        ...
        {{Form::number('years',$paymentscheme->years,['class'=>'form-control','placeholder'=>'Enter years ','required'=>true])}}
                  </div>
               </div>
