...
@section('content')
  <div class="container-fluid">
          ...
          <h5 class="h5 mb-2 text-gray-800">Report / Payment Scheme</h5>
        
        </div>
          <!-- DataTales Example -->
          <div class="card shadow mb-4">
             {{ Form::open(['action' => 'ReportSchemeController@store','method'=>'POST'])}}
            <div class="card-header py-3">
             ...
             {{Form::text('search',$search,['class'=>'form-control','placeholder'=>'Search here...'])}}
                  ...
                  <div class="col-lg-3 col-md-6 col-xs-12">
                   ...
                   <a href="/report-scheme/list_of_client" class="btn btn-success button-class">
