...
@section('content')
  <div class="container-fluid">
        ...
        {{Form::number('equity',$proptype->equity,['class'=>'form-control','placeholder'=>'Enter equity percentage','required'=>true])}}
                  </div>
               </div>
                 <div class="col-md-12">
                  <div class="form-group">
         {{Form::label('lastname_title', "Miscellaneous Percentage")}}
        {{Form::number('misc',$proptype->misc,['class'=>'form-control','placeholder'=>'Enter miscellaneous precentage','required'=>true])}}
                  </div>
               </div>
