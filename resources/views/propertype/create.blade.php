...
@section('content')
  <div class="container-fluid">
        ...
        {{Form::number('equity','',['class'=>'form-control','placeholder'=>'Enter equity percentage','required'=>true,'step'=>'0.0001'])}}
                  </div>
               </div>
                 <div class="col-md-12">
                  <div class="form-group">
         {{Form::label('lastname_title', "Miscellaneous Percentage")}}
        {{Form::number('misc','',['class'=>'form-control','placeholder'=>'Enter miscellaneous precentage','required'=>true,'step'=>'0.0001'])}}
                  </div>
               </div>
