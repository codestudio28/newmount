...
@section('content')
  <div class="container-fluid">
          ...
          <h5 class="h5 mb-2 text-gray-800"><a href="/admin-banner">Banner</a> / Update Banner</h5>
       
        
        </div>
          <!-- DataTales Example -->
           {{ Form::open(['action' => ['BannerController@update',$banner->id],'method'=>'POST','enctype'=>'multipart/form-data'])}}
          <div class="row">
        ...
        {{Form::text('title',$banner->title,['class'=>'form-control','placeholder'=>'Enter banner title','required'=>true])}}
                  </div>
               </div>
                 </div>
                    <div style="margin-top:1em;" class="col-md-12  ">
