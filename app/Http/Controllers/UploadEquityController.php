...
use App\Equity;
use App\Log;
class UploadEquityController extends Controller
{
    /**
    ...
    public function update(Request $request, $id)
    {
         $upload = $request->file('import_file');
                ...
                while($columns=fgetcsv($file)){
                    ...
                    $newequity=Equity::where('client_id',$client_id)->where('property_id',$property_id)->where('date',$newdatedue)->get();
        ...
        $log->module="Equity";
        $log->description="Import equity";
        $log->save();
             return redirect('/admin-collection')->with('success','Successfully import equity collection to the system. ');
    }
